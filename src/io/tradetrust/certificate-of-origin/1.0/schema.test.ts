...
const sampleDocument = {
  name: "TradeTrust Certificate of Origin v3",
  supplyChainConsignment: {
    ...
    exporter: {
      postalAddress: {
        line1: "exporter add 1",
        line2: "exporter add 2",
        cityName: "exporter city",
        postcode: "exporter postal",
        countrySubDivisionName: "exporter division name",
        countryCode: "exporter country",
      },
      iD: "exporter id",
      name: "exporter name",
    },
    ...
    importer: {
      postalAddress: {
        line1: "importer add 1",
        line2: "importer add 2",
        cityName: "importer city",
        postcode: "importer postal code",
        countrySubDivisionName: "importer country sub division",
        countryCode: "importer country code",
      },
      iD: "importer id",
      name: "importer name",
    },
